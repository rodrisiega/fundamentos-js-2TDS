//const numero;  //const não pode ser criada sem um valor
const numero = 1;
//console.log(numero   //erro de sintaxe )

console.log(minhaVar);  //erro de referência pois não encontrou a variável
